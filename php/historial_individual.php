    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <!-- marca -->
                <a class="navbar-brand" href="../index.php">REEC ONLINE</a>
            </div>
...
if (mysqli_connect_errno()) :
    ...
    // Vaciar historial de compras
    $query = "DELETE FROM historial_compras WHERE id_usuario = $id_usuario";
    if (mysqli_query($con, $query)) {
        echo "Historial de compras vaciado correctamente.";
    } else {
        echo "Error al vaciar el historial de compras: " . mysqli_error($con);
    }
...
<form action="../php/vaciar_historial.php" method="POST">
    <button type="submit" class="btn btn-danger">Vaciar historial de compras</button>
</form>
